 ...
 * Domain/b/singleBlog/how-to-handle-promises-parallely-in-nodejs
 */
...
/**
 * This is the main function of the script. It gets all the necessary
 * links and writes them to the given destination.
 *
 * Our sitemap is split into multiple sitemaps because of the number
 * of links that are generated. The main file sitemap.xml is the
 * sitemap index file that contains links of other sitemaps.
 *
...
main()
    .then(() => {
      ...
      // Due to the script not exiting on Gitlab runner,
      // we need to explicitly exit from here.
      process.exit(0);
    })
    .catch((err) => {
