...
const User = require('../../../src/app/helium/models/user');
...
describe('login api test cases', () => {
  it('should login', async () => {
    ...
    user.email = 'piyush@turtleopedia.com';
    user.password_hash = await util.getPasswordHash('password');

    const finalUser = await user.save();
    const body = {
      email: 'piyush@turtleopedia.com',
      password: 'password',
    };
    const url = '/helium/login';
